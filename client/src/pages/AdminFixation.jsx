// client/src/pages/AdminFixation.jsx
...
export default function AdminFixation() {
  ...
  const load = async () => {
    ...
    setError("");
    try {
      const res = await fetch(`${API}/api/fixations`, { headers: authHeaders(false) });
  ...
  return (
    <div className="card">
      <div className="card-title">Fixation</div>

      <div className="page-actions" style={{ flexWrap: "wrap", marginBottom: 12 }}>
        <input
          className="input"
          placeholder="Nom (ex: Standard / Spécial)"
          value={name}
